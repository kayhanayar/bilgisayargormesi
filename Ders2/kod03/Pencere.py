...
class AnaPencere(QMainWindow):
    def __init__(self):
        ...
        self.lblResim3 = QLabel("resim label2",self.central_widget)
        ...
        self.hLayout.addWidget(self.lblResim3)  
    ...
    def filtreUygula(self):
        ...
        self.median_image=cv2.medianBlur(self.image,5)

        self.blur_image = cv2.cvtColor(self.blur_image,cv2.COLOR_RGB2BGR)
        self.median_image = cv2.cvtColor(self.median_image,cv2.COLOR_RGB2BGR)
        ...
        qImg = QtGui.QImage(self.median_image.data, width, height, bytesPerLine, QtGui.QImage.Format_RGB888)
        self.lblResim3.setPixmap(QtGui.QPixmap.fromImage(qImg))
